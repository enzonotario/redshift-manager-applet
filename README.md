...
1. Clone the repository:
   ```bash
   git clone https://github.com/enzonotario/redshift-manager-applet.git
   cd redshift-manager-applet
   ```
...
3. Add to panel:
   - Right-click on Cinnamon panel → **Applets**
   - Find "Redshift Manager Applet" and click **+** to add it
